...
[ -x "$PROJECT_DIR/scripts/resolve-spec.sh" ] || error "Required script is not executable: scripts/resolve-spec.sh"
...
package_entries=(preset.yml workflow.yml README.md commands templates scripts)
