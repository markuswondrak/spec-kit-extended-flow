...
assert_zip_contains "$EXT_LIST" "commands/speckit.extendedflow.triage.md" "extension archive has triage command"
...
assert_zip_contains "$PRESET_LIST" "templates/triage.md" "preset archive has triage template"
